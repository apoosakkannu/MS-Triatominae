...
#Read the OTU file
abund_table<-read.csv("D:/Czech/triatomine_manuscript/MS-Triatominae/data/Originaldata_negative/otu_norarefaction_decontam_negative_abund.csv",row.names=1,check.names=FALSE)
...
#Read the taxonomy
OTU_taxonomy<-read.csv("D:/Czech/triatomine_manuscript/MS-Triatominae/data/Originaldata_negative/otu_norarefaction_decontam_negative_taxa.csv",row.names=1,check.names=FALSE)
...
```{r}
########## Full visualisation of bacterial taxa #############
